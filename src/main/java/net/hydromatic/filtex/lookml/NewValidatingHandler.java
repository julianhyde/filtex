...
abstract class NewValidatingHandler implements ObjectHandler {
  protected final PropertyHandler consumer;
  protected final Map<String, LookmlSchema.Property> propertyMap;

  NewValidatingHandler(PropertyHandler consumer,
   ...
   * document. */
  private static class NonRootValidatingHandler extends NewValidatingHandler {
  ...
  /** Implementation of {@link NewValidatingHandler}
   * that stores the common data in a tree of handlers. */
  private static class RootValidatingHandler extends NewValidatingHandler {
