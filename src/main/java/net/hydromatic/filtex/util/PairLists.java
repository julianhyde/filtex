...
import static net.hydromatic.filtex.util.Nullness.castNonNull;
import static net.hydromatic.filtex.util.Nullness.castNonNullArray;
import static net.hydromatic.filtex.util.Nullness.castNonNullList;
